...
A_REFUND_BET = 'refund_bet'
A_DEPOSIT_ACCEPT = 'accept_deposit'
A_DEPOSIT_CANCEL = 'cancel_deposit'
A_WITHDRAW_ACCEPT = 'accept_withdraw'
A_WITHDRAW_CANCEL = 'cancel_withdraw'
A_TRANSFER_ACCEPT = 'accept_transfer'
A_TRANSFER_CANCEL = 'cancel_transfer'
